...
# Criando os botões
btn_confirmar = tk.Button(urna, border=0, width=8, height=2, text='confirmar', )
btn_confirmar.place(x=810, y=475)

############ FIM DA CRIAÇÃO DA WINDOW ############

############ CRIANDO FRAME INCIAL ############
# frame_voto = tk.Frame(urna, bd=5, width=510, height=297, background="grey")
...
# frame_candidato_foto = tk.Frame(urna, bd=5, width=510, height=297, background="grey")
...
############ CRIANDO FRAME FIM ############
# frame_fim = tk.Frame(urna, bd=5, width=510, height=297, background="grey")
...
frame_branco = tk.Frame(urna, bd=5, width=510, height=297, background="grey")
